...
class FileDeleteViewTest(TestCase):
    ...
    def test_delete_does_not_exist(self):
        ...
        url = reverse("shifter_files:file-delete", args=["0" * 32])
    ...
    def test_delete_expired(self):
        ...
        url = reverse("shifter_files:file-delete", args=[file_upload.file_hex])
        response = client.post(url)
        self.assertEqual(response.status_code, 404)
    ...
    def test_get_redirect(self):
        ...
        self.assertTrue(
            response.url,
            reverse("shifter_files:file-details", args=[file_upload.file_hex]),
        )
    ...
    def test_delete_file(self):
        ...
        response = client.post(url)
        self.assertEqual(response.status_code, 302)
        self.assertTrue(response.url, reverse("shifter_files:myfiles"))
